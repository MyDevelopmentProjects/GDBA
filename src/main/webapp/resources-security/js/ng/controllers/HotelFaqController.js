angular.module('app').controller('HotelFaqController',
    ['$scope', '$http', 'GridManager', 'ModalManager','FileUploader', function ($scope, $http, GridManager, ModalManager, FileUploader) {
        ...
        $scope.showAddEdit = function (item) {
            ...
            $scope.object = {};
            $scope.object.category = $scope.faqCategory[1].name;
            if (item) {
        ...
        $scope.save = function () {
            ...
            copyObject.category = $scope.faqCategory[1].name;

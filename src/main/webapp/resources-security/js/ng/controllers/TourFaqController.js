angular.module('app').controller('TourFaqController',
    ['$scope', '$http', 'GridManager', 'ModalManager', 'FileUploader', function ($scope, $http, GridManager, ModalManager, FileUploader) {
        ...
        $scope.showAddEdit = function (item) {
            ...
            $scope.object = {};
            $scope.object.category = $scope.faqCategory[2].name;
            if (item) {
        ...
        $scope.save = function () {
            ...
            copyObject.category = $scope.faqCategory[2].name;

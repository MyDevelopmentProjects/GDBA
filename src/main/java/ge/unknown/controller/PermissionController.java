...
import ge.unknown.service.PermissionService;
...
public class PermissionController {
    ...
    public PaginationAndFullSearchQueryResult getList(
        ...
        return permissionService.getList(searchExpression, sortField, isAscending, pageNumber, pageSize);
    }

    @RequestMapping(value = SLASH + PUT, method = RequestMethod.POST)
    @ResponseBody
    public RequestResponse save(@RequestBody Permission permission) {
